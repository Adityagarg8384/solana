...
const Profile = () => {
    ...
    // Render when the user is new (check from blockchain)
    // return ( 
    ...
    //                 </div>
    //             </div>
    //             <button onClick={submitHandler} className="px-4 py-2 text-3xl bg-[#FFE502] rounded-lg font-sans">
    //                 Submit
    //             </button>
    //         </div>
    //     </div> 
    ...
    // Render when the user is not new (fetch details of the user from blockchain)
    return (
        <div className="w-full bg-white text-black min-h-lvh pb-10 flex gap-y-8 flex-col items-center">
            <div className="flex flex-col gap-y-7 justify-center items-center w-full">
                <div className="flex flex-col items-center m-auto w-10/12">
                ...
                <div className="flex flex-col gap-y-3 justify-center items-center w-full">
                    <div className="flex flex-col gap-y-7 justify-center items-center w-full">
                        <div className="flex flex-col items-center m-auto w-10/12 max-w-[1440px]">
                            <h1 className="text-5xl place-self-start font-semibold font-sans">Profile Information</h1>
                            <ProfileHeaderSecond />
                        </div>
                    </div>
